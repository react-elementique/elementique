...
`;g.__docgenInfo={description:"",methods:[],displayName:"Input",props:{variant:{required:!1,tsType:{name:"union",raw:'"primary" | "float"',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"float"'}]},description:""},name:{required:!1,tsType:{name:"union",raw:'string | "float_input"',elements:[{name:"string"},{name:"literal",value:'"float_input"'}]},description:""},type:{required:!1,tsType:{name:"union",raw:'string | "text"',elements:[{name:"string"},{name:"literal",value:'"text"'}]},description:""},width:{required:!1,tsType:{name:"union",raw:'string | "100%"',elements:[{name:"string"},{name:"literal",value:'"100%"'}]},description:""},maxWidth:{required:!1,tsType:{name:"union",raw:'string | "640px"',elements:[{name:"string"},{name:"literal",value:'"640px"'}]},description:""},p:{required:!1,tsType:{name:"string"},description:""},placeholder:{required:!1,tsType:{name:"string"},description:""},setValue:{required:!1,tsType:{name:"ReactDispatch",raw:"React.Dispatch<React.SetStateAction<string>>",elements:[{name:"ReactSetStateAction",raw:"React.SetStateAction<string>",elements:[{name:"string"}]}]},description:""},value:{required:!1,tsType:{name:"string"},description:""},border:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    ...
    weight?: number;
    family?: string;
}`,signature:{properties:[{key:"size",value:{name:"string",required:!1}},{key:"weight",value:{name:"number",required:!1}},{key:"family",value:{name:"string",required:!1}}]}},description:""},hasValue:{required:!1,tsType:{name:"boolean"},description:""}}};const P={title:"Input",component:x},r={args:{placeholder:"Enter text",type:"text",variant:"primary"}},n={args:{placeholder:"Enter text",type:"text",variant:"float"}};var m,u,p;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    placeholder: "Enter text",
    type: "text",
    variant: "primary"
  }
}`,...(p=(u=r.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var f,y,c;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    placeholder: "Enter text",
    type: "text",
    variant: "float"
  }
}`,...(c=(y=n.parameters)==null?void 0:y.docs)==null?void 0:c.source}}};const $=["Primary","Float"],S=Object.freeze(Object.defineProperty({__proto__:null,Float:n,Primary:r,__namedExportsOrder:$,default:P},Symbol.toStringTag,{value:"Module"}));export{n as F,S as I,r as P};
